...
service pancake_thrift {
  ...
  oneway void async_get(
    1: sequence_id seq_id,
    2: string key
  )

  oneway void async_put(
    1: sequence_id seq_id,
    2: string key,
    3: string value
  )

  oneway void async_get_batch(
    1: sequence_id seq_id,
    2: list<string> keys
  )

  oneway void async_put_batch(
    1: sequence_id seq_id,
    2: list<string> keys,
