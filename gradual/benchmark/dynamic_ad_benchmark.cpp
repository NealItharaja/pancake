...
int main(int argc, char** argv) {
    ...
    std::cerr << "Running gradual AD benchmark...\n";

    const ad::BenchmarkResult result = ad::Benchmark::run(domain_size, window_size, init_theta, final_theta, alpha);

    std::cout << "ad_stat=" << result.ad_statistic << " threshold=" << result.threshold << " num_ops=" << result.num_ops << "\n";
