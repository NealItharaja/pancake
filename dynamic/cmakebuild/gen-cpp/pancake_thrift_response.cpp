...
pancake_thrift_response_async_response_args::~pancake_thrift_response_async_response_args() noexcept {
}
...
pancake_thrift_response_async_response_pargs::~pancake_thrift_response_async_response_pargs() noexcept {
}
...
::std::shared_ptr< ::apache::thrift::TProcessor > pancake_thrift_responseProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< pancake_thrift_responseIfFactory > cleanup(handlerFactory_);
  ::std::shared_ptr< pancake_thrift_responseIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::std::shared_ptr< ::apache::thrift::TProcessor > processor(new pancake_thrift_responseProcessor(handler));
  return processor;
}
