...
class pancake_thrift_responseIfSingletonFactory : virtual public pancake_thrift_responseIfFactory {
 public:
  pancake_thrift_responseIfSingletonFactory(const ::std::shared_ptr<pancake_thrift_responseIf>& iface) : iface_(iface) {}
  virtual ~pancake_thrift_responseIfSingletonFactory() {}

  virtual pancake_thrift_responseIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(pancake_thrift_responseIf* /* handler */) override {}
...
class pancake_thrift_response_async_response_args {
 public:
  ...
  pancake_thrift_response_async_response_args() noexcept
                                              : op_code(0) {
  }

  virtual ~pancake_thrift_response_async_response_args() noexcept;
  sequence_id seq_id;
  int32_t op_code;
...
class pancake_thrift_response_async_response_pargs {
 public:
  ...
  virtual ~pancake_thrift_response_async_response_pargs() noexcept;
...
class pancake_thrift_responseClient : virtual public pancake_thrift_responseIf {
 public:
  pancake_thrift_responseClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
...
class pancake_thrift_responseProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  pancake_thrift_responseProcessor(::std::shared_ptr<pancake_thrift_responseIf> iface) :
    iface_(iface) {
...
class pancake_thrift_responseProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  pancake_thrift_responseProcessorFactory(const ::std::shared_ptr< pancake_thrift_responseIfFactory >& handlerFactory) noexcept :
...
class pancake_thrift_responseMultiface : virtual public pancake_thrift_responseIf {
 public:
  pancake_thrift_responseMultiface(std::vector<std::shared_ptr<pancake_thrift_responseIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~pancake_thrift_responseMultiface() {}
 protected:
  std::vector<std::shared_ptr<pancake_thrift_responseIf> > ifaces_;
  pancake_thrift_responseMultiface() {}
  void add(::std::shared_ptr<pancake_thrift_responseIf> iface) {
...
class pancake_thrift_responseConcurrentClient : virtual public pancake_thrift_responseIf {
 public:
  pancake_thrift_responseConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(prot);
  }
  pancake_thrift_responseConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(iprot,oprot);
  }
 private:
