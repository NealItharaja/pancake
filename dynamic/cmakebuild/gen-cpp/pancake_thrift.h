...
class pancake_thriftIfSingletonFactory : virtual public pancake_thriftIfFactory {
 public:
  pancake_thriftIfSingletonFactory(const ::std::shared_ptr<pancake_thriftIf>& iface) : iface_(iface) {}
  virtual ~pancake_thriftIfSingletonFactory() {}

  virtual pancake_thriftIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(pancake_thriftIf* /* handler */) override {}
...
class pancake_thrift_get_client_id_args {
 public:
  ...
  pancake_thrift_get_client_id_args(const pancake_thrift_get_client_id_args&) noexcept;
  pancake_thrift_get_client_id_args& operator=(const pancake_thrift_get_client_id_args&) noexcept;
  pancake_thrift_get_client_id_args() noexcept {
  }

  virtual ~pancake_thrift_get_client_id_args() noexcept;
...
class pancake_thrift_get_client_id_pargs {
 public:
  ...
  virtual ~pancake_thrift_get_client_id_pargs() noexcept;
...
class pancake_thrift_get_client_id_result {
 public:
  ...
  pancake_thrift_get_client_id_result(const pancake_thrift_get_client_id_result&) noexcept;
  pancake_thrift_get_client_id_result& operator=(const pancake_thrift_get_client_id_result&) noexcept;
  pancake_thrift_get_client_id_result() noexcept
                                      : success(0) {
  }

  virtual ~pancake_thrift_get_client_id_result() noexcept;
  int64_t success;
...
class pancake_thrift_get_client_id_presult {
 public:
  ...
  virtual ~pancake_thrift_get_client_id_presult() noexcept;
  int64_t* success;
...
class pancake_thrift_register_client_id_args {
 public:
  ...
  pancake_thrift_register_client_id_args(const pancake_thrift_register_client_id_args&) noexcept;
  pancake_thrift_register_client_id_args& operator=(const pancake_thrift_register_client_id_args&) noexcept;
  pancake_thrift_register_client_id_args() noexcept
                                         : block_id(0),
                                           client_id(0) {
  }

  virtual ~pancake_thrift_register_client_id_args() noexcept;
  int32_t block_id;
  int64_t client_id;
...
class pancake_thrift_register_client_id_pargs {
 public:
  ...
  virtual ~pancake_thrift_register_client_id_pargs() noexcept;
...
class pancake_thrift_register_client_id_result {
 public:
  ...
  pancake_thrift_register_client_id_result(const pancake_thrift_register_client_id_result&) noexcept;
  pancake_thrift_register_client_id_result& operator=(const pancake_thrift_register_client_id_result&) noexcept;
  pancake_thrift_register_client_id_result() noexcept {
  }

  virtual ~pancake_thrift_register_client_id_result() noexcept;
...
class pancake_thrift_register_client_id_presult {
 public:
  ...
  virtual ~pancake_thrift_register_client_id_presult() noexcept;
...
class pancake_thrift_async_get_args {
 public:
  ...
  pancake_thrift_async_get_args() noexcept
                                : key() {
  }

  virtual ~pancake_thrift_async_get_args() noexcept;
  sequence_id seq_id;
  std::string key;
...
class pancake_thrift_async_get_pargs {
 public:
  ...
  virtual ~pancake_thrift_async_get_pargs() noexcept;
...
class pancake_thrift_async_put_args {
 public:
  ...
  pancake_thrift_async_put_args() noexcept
                                : key(),
                                  value() {
  }

  virtual ~pancake_thrift_async_put_args() noexcept;
  sequence_id seq_id;
  std::string key;
  std::string value;
...
class pancake_thrift_async_put_pargs {
 public:
  ...
  virtual ~pancake_thrift_async_put_pargs() noexcept;
  const sequence_id* seq_id;
  const std::string* key;
...
class pancake_thrift_async_get_batch_args {
 public:
  ...
  pancake_thrift_async_get_batch_args() noexcept {
  }

  virtual ~pancake_thrift_async_get_batch_args() noexcept;
  sequence_id seq_id;
...
class pancake_thrift_async_get_batch_pargs {
 public:
  ...
  virtual ~pancake_thrift_async_get_batch_pargs() noexcept;
  const sequence_id* seq_id;
...
class pancake_thrift_async_put_batch_args {
 public:
  ...
  pancake_thrift_async_put_batch_args() noexcept {
  }

  virtual ~pancake_thrift_async_put_batch_args() noexcept;
  sequence_id seq_id;
  std::vector<std::string>  keys;
...
class pancake_thrift_async_put_batch_pargs {
 public:
  ...
  virtual ~pancake_thrift_async_put_batch_pargs() noexcept;
  const sequence_id* seq_id;
  const std::vector<std::string> * keys;
...
class pancake_thrift_get_args {
 public:
  ...
  pancake_thrift_get_args() noexcept
                          : key() {
  }

  virtual ~pancake_thrift_get_args() noexcept;
  std::string key;
...
class pancake_thrift_get_pargs {
 public:
  ...
  virtual ~pancake_thrift_get_pargs() noexcept;
  const std::string* key;
...
class pancake_thrift_get_result {
 public:
  ...
  pancake_thrift_get_result() noexcept
                            : success() {
  }

  virtual ~pancake_thrift_get_result() noexcept;
  std::string success;
...
class pancake_thrift_get_presult {
 public:
  ...
  virtual ~pancake_thrift_get_presult() noexcept;
  std::string* success;
...
class pancake_thrift_put_args {
 public:
  ...
  pancake_thrift_put_args() noexcept
                          : key(),
                            value() {
  }

  virtual ~pancake_thrift_put_args() noexcept;
  std::string key;
  std::string value;
...
class pancake_thrift_put_pargs {
 public:
  ...
  virtual ~pancake_thrift_put_pargs() noexcept;
  const std::string* key;
  const std::string* value;
...
class pancake_thrift_put_result {
 public:
  ...
  pancake_thrift_put_result(const pancake_thrift_put_result&) noexcept;
  pancake_thrift_put_result& operator=(const pancake_thrift_put_result&) noexcept;
  pancake_thrift_put_result() noexcept {
  }

  virtual ~pancake_thrift_put_result() noexcept;
...
class pancake_thrift_put_presult {
 public:
  ...
  virtual ~pancake_thrift_put_presult() noexcept;
...
class pancake_thrift_get_batch_args {
 public:
  ...
  pancake_thrift_get_batch_args() noexcept {
  }

  virtual ~pancake_thrift_get_batch_args() noexcept;
  std::vector<std::string>  keys;
...
class pancake_thrift_get_batch_pargs {
 public:
  ...
  virtual ~pancake_thrift_get_batch_pargs() noexcept;
  const std::vector<std::string> * keys;
...
class pancake_thrift_get_batch_result {
 public:
  ...
  pancake_thrift_get_batch_result() noexcept {
  }

  virtual ~pancake_thrift_get_batch_result() noexcept;
...
class pancake_thrift_get_batch_presult {
 public:
  ...
  virtual ~pancake_thrift_get_batch_presult() noexcept;
  std::vector<std::string> * success;
...
class pancake_thrift_put_batch_args {
 public:
  ...
  pancake_thrift_put_batch_args() noexcept {
  }

  virtual ~pancake_thrift_put_batch_args() noexcept;
  std::vector<std::string>  keys;
  std::vector<std::string>  values;
...
class pancake_thrift_put_batch_pargs {
 public:
  ...
  virtual ~pancake_thrift_put_batch_pargs() noexcept;
  const std::vector<std::string> * keys;
  const std::vector<std::string> * values;
...
class pancake_thrift_put_batch_result {
 public:
  ...
  pancake_thrift_put_batch_result(const pancake_thrift_put_batch_result&) noexcept;
  pancake_thrift_put_batch_result& operator=(const pancake_thrift_put_batch_result&) noexcept;
  pancake_thrift_put_batch_result() noexcept {
  }

  virtual ~pancake_thrift_put_batch_result() noexcept;
...
class pancake_thrift_put_batch_presult {
 public:
  ...
  virtual ~pancake_thrift_put_batch_presult() noexcept;
...
class pancake_thriftClient : virtual public pancake_thriftIf {
 public:
  pancake_thriftClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  pancake_thriftClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class pancake_thriftProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  pancake_thriftProcessor(::std::shared_ptr<pancake_thriftIf> iface) :
    iface_(iface) {
...
class pancake_thriftProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  pancake_thriftProcessorFactory(const ::std::shared_ptr< pancake_thriftIfFactory >& handlerFactory) noexcept :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) override;

 protected:
  ::std::shared_ptr< pancake_thriftIfFactory > handlerFactory_;
};

class pancake_thriftMultiface : virtual public pancake_thriftIf {
 public:
  pancake_thriftMultiface(std::vector<std::shared_ptr<pancake_thriftIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~pancake_thriftMultiface() {}
 protected:
  std::vector<std::shared_ptr<pancake_thriftIf> > ifaces_;
  pancake_thriftMultiface() {}
  void add(::std::shared_ptr<pancake_thriftIf> iface) {
...
class pancake_thriftConcurrentClient : virtual public pancake_thriftIf {
 public:
  pancake_thriftConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(prot);
  }
  pancake_thriftConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(iprot,oprot);
  }
 private:
