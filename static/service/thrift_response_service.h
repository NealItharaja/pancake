...
public:
  ...
  virtual void async_response(const sequence_id& seq_id,
...
public:
  explicit pancake_thrift_responseIfSingletonFactory(
      const ::apache::thrift::stdcxx::shared_ptr<pancake_thrift_responseIf>& iface)
      : iface_(iface) {}
...
public:
  explicit pancake_thrift_responseClient(apache::thrift::stdcxx::shared_ptr<::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot, prot);
  }
  pancake_thrift_responseClient(apache::thrift::stdcxx::shared_ptr<::apache::thrift::protocol::TProtocol> iprot,
...
private:
  typedef void (pancake_thrift_responseProcessor::*ProcessFunction)(
      int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*, void*);
  typedef std::map<std::string, ProcessFunction> ProcessMap;
  ProcessMap processMap_;

  void process_async_response(int32_t,
                              ::apache::thrift::protocol::TProtocol* iprot,
                              ::apache::thrift::protocol::TProtocol*,
                              void* callContext);

public:
  explicit pancake_thrift_responseProcessor(::apache::thrift::stdcxx::shared_ptr<pancake_thrift_responseIf> iface)
      : iface_(iface) {
...
public:
  explicit pancake_thrift_responseProcessorFactory(
      const ::apache::thrift::stdcxx::shared_ptr<pancake_thrift_responseIfFactory>& handlerFactory)
